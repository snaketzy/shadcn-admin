...
import { Route as AuthenticatedCase_drydocking_listIndexRouteImport } from './routes/_authenticated/case_drydocking_list/index'
...
const AuthenticatedCase_drydocking_listIndexRoute =
  AuthenticatedCase_drydocking_listIndexRouteImport.update({
    id: '/case_drydocking_list/',
    path: '/case_drydocking_list/',
    getParentRoute: () => AuthenticatedRouteRoute,
  } as any)
const AuthenticatedCase_editCaseIdRoute =
  AuthenticatedCase_editCaseIdRouteImport.update({
    id: '/case_edit/$caseId',
    path: '/case_edit/$caseId',
    getParentRoute: () => AuthenticatedRouteRoute,
  } as any)
...
const AuthenticatedCase_newIndexRoute =
  AuthenticatedCase_newIndexRouteImport.update({
    id: '/case_new/',
    path: '/case_new/',
    getParentRoute: () => AuthenticatedRouteRoute,
  } as any)
const AuthenticatedCase_service_listIndexRoute =
  AuthenticatedCase_service_listIndexRouteImport.update({
    id: '/case_service_list/',
    path: '/case_service_list/',
    getParentRoute: () => AuthenticatedRouteRoute,
  } as any)
...
const AuthenticatedOwner_listIndexRoute =
  AuthenticatedOwner_listIndexRouteImport.update({
    id: '/owner_list/',
    path: '/owner_list/',
    getParentRoute: () => AuthenticatedRouteRoute,
  } as any)
...
const AuthenticatedSupplier_detailSupplierIdCooperationRoute =
  AuthenticatedSupplier_detailSupplierIdCooperationRouteImport.update({
    id: '/cooperation',
    path: '/cooperation',
    getParentRoute: () => AuthenticatedSupplier_detailSupplierIdRouteRoute,
  } as any)
...
export interface FileRoutesByFullPath {
  ...
  '/case_drydocking_list/': typeof AuthenticatedCase_drydocking_listIndexRoute
...
export interface FileRoutesById {
  ...
  '/_authenticated/case_drydocking_list/': typeof AuthenticatedCase_drydocking_listIndexRoute
...
export interface FileRouteTypes {
  ...
  id:
    ...
    | '/_authenticated/case_drydocking_list/'
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/_authenticated/case_drydocking_list/': {
      id: '/_authenticated/case_drydocking_list/'
      path: '/case_drydocking_list'
      fullPath: '/case_drydocking_list/'
      preLoaderRoute: typeof AuthenticatedCase_drydocking_listIndexRouteImport
      parentRoute: typeof AuthenticatedRouteRoute
    }
    '/_authenticated/case_edit/$caseId': {
      id: '/_authenticated/case_edit/$caseId'
      path: '/case_edit/$caseId'
      fullPath: '/case_edit/$caseId'
      preLoaderRoute: typeof AuthenticatedCase_editCaseIdRouteImport
      parentRoute: typeof AuthenticatedRouteRoute
    }
    '/_authenticated/case_list/': {
    ...
    '/_authenticated/case_new/': {
      id: '/_authenticated/case_new/'
      path: '/case_new'
      fullPath: '/case_new/'
      preLoaderRoute: typeof AuthenticatedCase_newIndexRouteImport
      parentRoute: typeof AuthenticatedRouteRoute
    }
    '/_authenticated/case_service_list/': {
      id: '/_authenticated/case_service_list/'
      path: '/case_service_list'
      fullPath: '/case_service_list/'
      preLoaderRoute: typeof AuthenticatedCase_service_listIndexRouteImport
      parentRoute: typeof AuthenticatedRouteRoute
    }
    '/_authenticated/case_today_list/': {
    ...
    '/_authenticated/owner_list/': {
      id: '/_authenticated/owner_list/'
      path: '/owner_list'
      fullPath: '/owner_list/'
      preLoaderRoute: typeof AuthenticatedOwner_listIndexRouteImport
      parentRoute: typeof AuthenticatedRouteRoute
    }
    '/_authenticated/settings/': {
      id: '/_authenticated/settings/'
    ...
    '/_authenticated/supplier_list/': {
      ...
      path: '/supplier_list'
      fullPath: '/supplier_list/'
      preLoaderRoute: typeof AuthenticatedSupplier_listIndexRouteImport
      parentRoute: typeof AuthenticatedRouteRoute
    }
    '/_authenticated/tasks/': {
    ...
    '/_authenticated/supplier_detail/$supplierId/cooperation': {
      id: '/_authenticated/supplier_detail/$supplierId/cooperation'
      path: '/cooperation'
      fullPath: '/supplier_detail/$supplierId/cooperation'
      preLoaderRoute: typeof AuthenticatedSupplier_detailSupplierIdCooperationRouteImport
      parentRoute: typeof AuthenticatedSupplier_detailSupplierIdRouteRoute
    }
    '/_authenticated/supplier_detail/$supplierId/info': {
...
interface AuthenticatedRouteRouteChildren {
  ...
  AuthenticatedCase_drydocking_listIndexRoute: typeof AuthenticatedCase_drydocking_listIndexRoute
...
const AuthenticatedRouteRouteChildren: AuthenticatedRouteRouteChildren = {
  ...
  AuthenticatedCase_drydocking_listIndexRoute:
    AuthenticatedCase_drydocking_listIndexRoute,
  AuthenticatedCase_listIndexRoute: AuthenticatedCase_listIndexRoute,
  AuthenticatedCase_newIndexRoute: AuthenticatedCase_newIndexRoute,
