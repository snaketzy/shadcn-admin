...
type DataTableRowActionsServiceProps = {
  row: Row<Case>
}

export function DataTableRowActionsService({
  row,
}: DataTableRowActionsServiceProps) {
  ...
  const deleteMutation = useMutation({
    ...
    onSuccess: (ok) => {
      if (ok) {
        ...
        queryClient.invalidateQueries({ queryKey: ['case-service-list-paginated'] })
        queryClient.invalidateQueries({ queryKey: ['case-service-list-groups'] })
        setDeleteOpen(false)
      } else {
