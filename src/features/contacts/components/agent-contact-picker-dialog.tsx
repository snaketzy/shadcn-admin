  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className='sm:max-w-[1200px]'>
        <DialogHeader>
          <DialogTitle>选择案件代理联系人</DialogTitle>
          <DialogDescription>
            从 {AGENT_CONTACT_TYPE} 类型联系人列表中选择作为案件代理，支持关键词搜索、列排序、行点击快速选择。
          </DialogDescription>
        </DialogHeader>
        <div className='flex flex-col gap-3'>
          <div className='flex flex-wrap items-center gap-2'>
            ...
            <div className='flex items-center gap-1 text-xs text-muted-foreground'>
              ...
              <span>
                共 {filteredRows.length} 条 / 总 {contacts.length} 条（类型 {AGENT_CONTACT_TYPE}）
              </span>
            </div>
          </div>
