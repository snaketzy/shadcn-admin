...
export type AgentPickerDialogProps = {
  open: boolean
  onOpenChange: (open: boolean) => void
  onSelect: (result: AgentPickerResult) => void
            ...
            <div className='flex justify-end'>
              <Button
                ...
                onClick={(e) => {
                  ...
                  const result: AgentPickerResult = {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className='sm:max-w-[1200px]'>
        <DialogHeader>
          ...
          <DialogDescription>
            从联系人类别为“案件代理”的列表中选择，支持关键词搜索、列排序、行点击快速选择。
          </DialogDescription>
        </DialogHeader>
                  ...
                  {contactsLoading ? (
                    ...
                    <TableRow>
                      ...
                      >
                        {searchKeyword.trim() !== ''
                          ? '未找到匹配的案件代理，请更换搜索关键词。'
                          : '暂无案件代理数据（请在联系人管理中维护 contact_type=J1 的记录）。'}
                      </TableCell>
                    </TableRow>
                  ) : (
