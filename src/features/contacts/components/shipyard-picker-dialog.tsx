...
export type ShipyardPickerResult = {
  contact_id: string
  contact_name: string
...
export type ShipyardPickerDialogProps = {
  open: boolean
  onOpenChange: (open: boolean) => void
  onSelect: (result: ShipyardPickerResult) => void
...
export function ShipyardPickerDialog({
  open,
  onOpenChange,
  onSelect,
  initialSelectedName,
}: ShipyardPickerDialogProps) {
            ...
            <div className='flex justify-end'>
              <Button
                ...
                onClick={(e) => {
                  ...
                  const result: ShipyardPickerResult = {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className='sm:max-w-[1200px]'>
        <DialogHeader>
          <DialogTitle>选择船厂经营</DialogTitle>
          <DialogDescription>
            从联系人类别为“船厂经营”的列表中选择，支持关键词搜索、列排序、行点击快速选择。
          </DialogDescription>
        </DialogHeader>
                  ...
                  {contactsLoading ? (
                    ...
                    <TableRow>
                      ...
                      >
                        {searchKeyword.trim() !== ''
                          ? '未找到匹配的船厂经营，请更换搜索关键词。'
                          : '暂无船厂经营数据（请在联系人管理中维护 contact_type=J4 的记录）。'}
                      </TableCell>
                    </TableRow>
                  ) : (
