...
import { CasesUrgent } from '@/features/cases-urgent'

const casesUrgentSearchSchema = z
  .object({
...
export const Route = createFileRoute('/_authenticated/case_urgent_list/')({
  validateSearch: casesUrgentSearchSchema,
  component: CasesUrgent,
})
