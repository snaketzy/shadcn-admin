...
import { CasesService } from '@/features/cases-service'

const casesServiceSearchSchema = z
  .object({
...
export const Route = createFileRoute('/_authenticated/case_service_list/')({
  validateSearch: casesServiceSearchSchema,
